...
from photonpy.smlm.drift_estimate import minEntropy,rcc,rcc3D

# Need to have CUDA installed
use_cuda = True


# Function to simulate an SMLM dataset in 3D with blinking molecules
def smlm_simulation(
        drift_trace,
    ...
    (assuming Z coordinates are in um and XY are in pixels)
    """
...
estimated_drift, _, _ = minEntropy(localizations, framenum,
                                  crlb,
